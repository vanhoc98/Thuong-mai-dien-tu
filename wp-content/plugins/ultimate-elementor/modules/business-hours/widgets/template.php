	...
	if ( count( $settings['business_days_timings'] ) ) {
		...
		<div class="uael-days">
			...
			foreach ( $settings['business_days_timings'] as $item ) {
				...
				?>
				<!-- CURRENT_ITEM div -->
				<div <?php echo $this->get_render_attribute_string( 'uael-bs-background' . $item['_id'] ); ?>>
					<div <?php echo $this->get_render_attribute_string( 'uael-inner-element' ); ?>>
						<span <?php echo $this->get_render_attribute_string( 'uael-highlight-day' . $item['_id'] ); ?>>
							<span <?php echo $this->get_render_attribute_string( $repeater_setting__enter_day ); ?>><?php echo $item['enter_day']; ?></span>
						</span>

						<span <?php echo $this->get_render_attribute_string( 'uael-highlight-time' . $item['_id'] ); ?>>
							<span <?php echo $this->get_render_attribute_string( 'uael-inner-heading-time' ); ?>>
