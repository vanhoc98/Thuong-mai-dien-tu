    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'slider_area_attr' ); ?> >
                ...
                <?php if( $settings['slider_navigation_style'] != 1 ){ echo '<div class="hero-slider-controls"></div>'; } ?>
            </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Htslider_Elementor_Widget_Sliders() );
