        ...
        <div class="ht-qwick-view-right">
            <div class="qwick-view-content">
    			...
    			<div class="content-quickview entry-summary">
    				<?php
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_title', 5 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_rating', 10 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_price', 10 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_excerpt', 20 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_add_to_cart', 30 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_meta', 40 );
                    add_action( 'woolentor_woocommerce_quickview_content', 'woocommerce_template_single_sharing', 50 );

                    // Render Content
                    do_action( 'woolentor_woocommerce_quickview_content' );
    				?>
    			</div><!-- .summary -->
